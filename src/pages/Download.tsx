    ...
    <>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-20">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="card p-8 text-center mb-8">
          ...
          <p className="text-gray-600 dark:text-text-secondary mb-6">Trình cài đặt NSIS • ~50MB</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}>
          ...
          <div className="space-y-4">
            {[
              { step: '1', title: 'Tải file cài đặt', desc: 'Nhấn nút tải xuống ở trên để lấy file PasswordVault_Setup_v1.0.0.exe.' },
