    ...
    <section id="download" className="py-20 bg-gray-50 dark:bg-background-secondary/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center">
        ...
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
          <Button variant="primary" className="text-lg px-8 py-4" href="/downloads/PasswordVault_Setup.exe" download>
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
            Tải xuống cho Windows
          </Button>
          <Button variant="secondary" className="text-lg px-8 py-4" href="/downloads/latest">
